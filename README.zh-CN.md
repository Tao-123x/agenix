...
可以使用 `agenix validate <path>` 对 manifest、trace、check report 或 adapter
compatibility report 做基于已发布 schema 的契约检查。
...
`agenix acceptance --v0.2` 是 V0.2 authoring release gate。它会从两个内置模板创建
